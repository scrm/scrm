...
ms 4 ${rep} -t ${theta} -I 2 2 2 5.0 -eN 0.4 10.01 -eN 1 0.01 -T  > msout
scrm 4 ${rep} -t ${theta} -I 2 2 2 -ma x 5.0 5.0 x -eN 0.4 10.01 -eN 1 0.01 -T > scrmout
...
ms 4 ${rep} -t ${theta} -I 2 2 2 -ma x 10.0 5.0 x -eN .5 0.01 -T > msout
scrm 4 ${rep} -t ${theta} -I 2 2 2 -ma x 10.0 5.0 x -eN .5 0.01 -T > scrmout
...
ms 15 ${rep} -t ${theta} -I 3 10 4 1 10.0 -eN 0.5 10.0 -T > msout
scrm 15 ${rep} -t ${theta} -I 3 10 4 1 -ma x 5.0 5.0 5.0 x 5.0 5.0 5.0 x -eN 0.5 10.0 -T > scrmout
...
ms 15 ${rep} -t ${theta} -I 3 10 4 1 -ma x 5.0 5.0 5.0 x 5.0 5.0 5.0 x -eN 0.8 15  -T > msout
scrm 15 ${rep} -t ${theta} -I 3 10 4 1 -ma x 5.0 5.0 5.0 x 5.0 5.0 5.0 x -eN 0.8 15  -T > scrmout
...
ms 15 ${rep} -t ${theta} -I 3 10 4 1 -ma x 1.0 2.0 3.0 x 4.0 5.0 6.0 x -eN 1 .1 -eN 3 10 -T > msout
scrm 15 ${rep} -t ${theta} -I 3 10 4 1 -ma x 1.0 2.0 3.0 x 4.0 5.0 6.0 x -eN 1 .1 -eN 3 10 -T > scrmout
