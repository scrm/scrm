...
ms_     = read.table( "ms_stat")# ,  colClasses = "numeric" )
scrm_   = read.table( "scrm_stat")# , colClasses = "numeric" )
scrm_p10000_ = read.table( "scrmprune10000_stat")# ,colClasses = "numeric" )
scrm_p50000_ = read.table( "scrmprune50000_stat")# ,colClasses = "numeric" )
