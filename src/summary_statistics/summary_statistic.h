...
class SummaryStatistic 
{
 public:
   ...
   virtual void initialize();
     ...
     virtual void calculate(const Forest &forest, const SummaryStatistic &sum_stat);

   virtual void printPerLocus(ostream &output);
   virtual void printFinal(ostream &output);
};
